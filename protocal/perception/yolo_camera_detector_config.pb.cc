...
#include "perception/yolo_camera_detector_config.pb.h"
...
void protobuf_AssignDesc_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto() {
  protobuf_AddDesc_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "perception/yolo_camera_detector_config.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto);
}
...
void protobuf_ShutdownFile_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto() {
  ...
  delete ModelConfigs::_default_yolo_root_;
}

void protobuf_AddDesc_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    ".proto\022-apollo.perception.yolo_camera_de"
    "tector_config\"\202\001\n\014ModelConfigs\022 \n\004name\030\001"
    " \001(\t:\022YoloCameraDetector\022\026\n\007version\030\002 \001("
    "\t:\0051.0.0\0228\n\tyolo_root\030\003 \001(\t:%perception/"
    "model/yolo_camera_detector", 226);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "perception/yolo_camera_detector_config.proto", &protobuf_RegisterTypes);
  ModelConfigs::_default_name_ =
      new ::std::string("YoloCameraDetector", 18);
  ModelConfigs::_default_version_ =
      new ::std::string("1.0.0", 5);
  ModelConfigs::_default_yolo_root_ =
      new ::std::string("perception/model/yolo_camera_detector", 37);
  ModelConfigs::default_instance_ = new ModelConfigs();
  ModelConfigs::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto {
  StaticDescriptorInitializer_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto() {
    protobuf_AddDesc_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto();
  }
} static_descriptor_initializer_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto_;

// ===================================================================

::std::string* ModelConfigs::_default_name_ = NULL;
::std::string* ModelConfigs::_default_version_ = NULL;
::std::string* ModelConfigs::_default_yolo_root_ = NULL;
...
ModelConfigs::ModelConfigs()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:apollo.perception.yolo_camera_detector_config.ModelConfigs)
}
...
void ModelConfigs::SharedCtor() {
  ...
  yolo_root_.UnsafeSetDefault(_default_yolo_root_);
...
void ModelConfigs::SharedDtor() {
  ...
  yolo_root_.DestroyNoArena(_default_yolo_root_);
...
const ModelConfigs& ModelConfigs::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_perception_2fyolo_5fcamera_5fdetector_5fconfig_2eproto();
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:apollo.perception.yolo_camera_detector_config.ModelConfigs)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_yolo_root;
        break;
      }
...
success:
  // @@protoc_insertion_point(parse_success:apollo.perception.yolo_camera_detector_config.ModelConfigs)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:apollo.perception.yolo_camera_detector_config.ModelConfigs)
  return false;
#undef DO_
}
...
void ModelConfigs::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:apollo.perception.yolo_camera_detector_config.ModelConfigs)
  // optional string name = 1 [default = "YoloCameraDetector"];
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:apollo.perception.yolo_camera_detector_config.ModelConfigs)
}
...
// @@protoc_insertion_point(generalized_merge_from_start:apollo.perception.yolo_camera_detector_config.ModelConfigs)
  ...
  const ModelConfigs* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const ModelConfigs>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:apollo.perception.yolo_camera_detector_config.ModelConfigs)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:apollo.perception.yolo_camera_detector_config.ModelConfigs)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.perception.yolo_camera_detector_config.ModelConfigs)
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_yolo_root()) {
      set_has_yolo_root();
      yolo_root_.AssignWithDefault(_default_yolo_root_, from.yolo_root_);
    }
  }
...
// @@protoc_insertion_point(generalized_copy_from_start:apollo.perception.yolo_camera_detector_config.ModelConfigs)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
