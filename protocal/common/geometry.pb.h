...
class PointENU : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.common.PointENU) */ {
 ...
 private:
  ...
  double y_;
  double z_;
  friend void  protobuf_AddDesc_common_2fgeometry_2eproto();
  friend void protobuf_AssignDesc_common_2fgeometry_2eproto();
  friend void protobuf_ShutdownFile_common_2fgeometry_2eproto();
