...
// source: perception/probabilistic_fusion_config.proto

#define INTERNAL_SUPPRESS_PROTOBUF_FIELD_DEPRECATION
#include "perception/probabilistic_fusion_config.pb.h"
...
void protobuf_AssignDesc_perception_2fprobabilistic_5ffusion_5fconfig_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AssignDesc_perception_2fprobabilistic_5ffusion_5fconfig_2eproto() {
  protobuf_AddDesc_perception_2fprobabilistic_5ffusion_5fconfig_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "perception/probabilistic_fusion_config.proto");
  GOOGLE_CHECK(file != NULL);
  ModelConfigs_descriptor_ = file->message_type(0);
  static const int ModelConfigs_offsets_[14] = {
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_perception_2fprobabilistic_5ffusion_5fconfig_2eproto);
}
...
void protobuf_ShutdownFile_perception_2fprobabilistic_5ffusion_5fconfig_2eproto() {
...
void protobuf_AddDesc_perception_2fprobabilistic_5ffusion_5fconfig_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_perception_2fprobabilistic_5ffusion_5fconfig_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    ".proto\022-apollo.perception.probabilistic_"
    "fusion_config\"\371\003\n\014ModelConfigs\022!\n\004name\030\001"
    " \001(\t:\023ProbabilisticFusion\022\026\n\007version\030\002 \001"
    "(\t:\0051.0.0\022 \n\014match_method\030\003 \001(\t:\nhm_matc"
    "her\022\035\n\022max_match_distance\030\004 \001(\002:\0014\022(\n\032ma"
    "x_lidar_invisible_period\030\005 \001(\002:\0040.25\022(\n\032"
    "max_radar_invisible_period\030\006 \001(\002:\0040.25\022%"
    "\n\031max_radar_confident_angle\030\007 \001(\002:\00230\022(\n"
    "\034min_radar_confident_distance\030\010 \001(\002:\00240\022"
    "\"\n\024publish_if_has_lidar\030\t \001(\010:\004true\022\"\n\024p"
    "ublish_if_has_radar\030\n \001(\010:\004true\022#\n\016publi"
    "sh_sensor\030\013 \001(\t:\013velodyne_64\022\027\n\tuse_rada"
    "r\030\014 \001(\010:\004true\022\027\n\tuse_lidar\030\r \001(\010:\004true\022)"
    "\n\033max_camera_invisible_period\030\016 \001(\002:\0040.2"
    "5", 601);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "perception/probabilistic_fusion_config.proto", &protobuf_RegisterTypes);
  ModelConfigs::_default_name_ =
      new ::std::string("ProbabilisticFusion", 19);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_perception_2fprobabilistic_5ffusion_5fconfig_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_perception_2fprobabilistic_5ffusion_5fconfig_2eproto {
  StaticDescriptorInitializer_perception_2fprobabilistic_5ffusion_5fconfig_2eproto() {
    protobuf_AddDesc_perception_2fprobabilistic_5ffusion_5fconfig_2eproto();
  }
} static_descriptor_initializer_perception_2fprobabilistic_5ffusion_5fconfig_2eproto_;
...
ModelConfigs::ModelConfigs()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:apollo.perception.probabilistic_fusion_config.ModelConfigs)
}
...
const ModelConfigs& ModelConfigs::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_perception_2fprobabilistic_5ffusion_5fconfig_2eproto();
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:apollo.perception.probabilistic_fusion_config.ModelConfigs)
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 13: {
        ...
        if (input->ExpectTag(117)) goto parse_max_camera_invisible_period;
        break;
      }
      ...
      case 14: {
        if (tag == 117) {
         parse_max_camera_invisible_period:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   float, ::google::protobuf::internal::WireFormatLite::TYPE_FLOAT>(
...
success:
  // @@protoc_insertion_point(parse_success:apollo.perception.probabilistic_fusion_config.ModelConfigs)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:apollo.perception.probabilistic_fusion_config.ModelConfigs)
  return false;
#undef DO_
}
...
void ModelConfigs::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:apollo.perception.probabilistic_fusion_config.ModelConfigs)
  // optional string name = 1 [default = "ProbabilisticFusion"];
  if (has_name()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->name().data(), this->name().length(),
  ...
  // @@protoc_insertion_point(serialize_end:apollo.perception.probabilistic_fusion_config.ModelConfigs)
}
...
// @@protoc_insertion_point(generalized_merge_from_start:apollo.perception.probabilistic_fusion_config.ModelConfigs)
  ...
  const ModelConfigs* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const ModelConfigs>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:apollo.perception.probabilistic_fusion_config.ModelConfigs)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:apollo.perception.probabilistic_fusion_config.ModelConfigs)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:apollo.perception.probabilistic_fusion_config.ModelConfigs)
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (from.has_max_camera_invisible_period()) {
      set_max_camera_invisible_period(from.max_camera_invisible_period());
    }
  }
...
// @@protoc_insertion_point(generalized_copy_from_start:apollo.perception.probabilistic_fusion_config.ModelConfigs)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void ModelConfigs::clear_name() {
 ...
 const ::std::string& ModelConfigs::name() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.name)
 ...
 void ModelConfigs::set_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.name)
}
 void ModelConfigs::set_name(const char* value) {
  set_has_name();
  name_.SetNoArena(_default_name_, ::std::string(value));
  // @@protoc_insertion_point(field_set_char:apollo.perception.probabilistic_fusion_config.ModelConfigs.name)
}
 void ModelConfigs::set_name(const char* value, size_t size) {
  set_has_name();
  name_.SetNoArena(_default_name_,
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:apollo.perception.probabilistic_fusion_config.ModelConfigs.name)
}
 ::std::string* ModelConfigs::mutable_name() {
  set_has_name();
  // @@protoc_insertion_point(field_mutable:apollo.perception.probabilistic_fusion_config.ModelConfigs.name)
  return name_.MutableNoArena(_default_name_);
}
 ::std::string* ModelConfigs::release_name() {
  // @@protoc_insertion_point(field_release:apollo.perception.probabilistic_fusion_config.ModelConfigs.name)
  clear_has_name();
 ...
 void ModelConfigs::set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:apollo.perception.probabilistic_fusion_config.ModelConfigs.name)
}
...
void ModelConfigs::clear_version() {
 ...
 const ::std::string& ModelConfigs::version() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.version)
 ...
 void ModelConfigs::set_version(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.version)
}
 void ModelConfigs::set_version(const char* value) {
  set_has_version();
  version_.SetNoArena(_default_version_, ::std::string(value));
  // @@protoc_insertion_point(field_set_char:apollo.perception.probabilistic_fusion_config.ModelConfigs.version)
}
 void ModelConfigs::set_version(const char* value, size_t size) {
  set_has_version();
  version_.SetNoArena(_default_version_,
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:apollo.perception.probabilistic_fusion_config.ModelConfigs.version)
}
 ::std::string* ModelConfigs::mutable_version() {
  set_has_version();
  // @@protoc_insertion_point(field_mutable:apollo.perception.probabilistic_fusion_config.ModelConfigs.version)
  return version_.MutableNoArena(_default_version_);
}
 ::std::string* ModelConfigs::release_version() {
  // @@protoc_insertion_point(field_release:apollo.perception.probabilistic_fusion_config.ModelConfigs.version)
  clear_has_version();
 ...
 void ModelConfigs::set_allocated_version(::std::string* version) {
  ...
  // @@protoc_insertion_point(field_set_allocated:apollo.perception.probabilistic_fusion_config.ModelConfigs.version)
}
...
void ModelConfigs::clear_match_method() {
 ...
 const ::std::string& ModelConfigs::match_method() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.match_method)
 ...
 void ModelConfigs::set_match_method(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.match_method)
}
 void ModelConfigs::set_match_method(const char* value) {
  set_has_match_method();
  match_method_.SetNoArena(_default_match_method_, ::std::string(value));
  // @@protoc_insertion_point(field_set_char:apollo.perception.probabilistic_fusion_config.ModelConfigs.match_method)
}
 void ModelConfigs::set_match_method(const char* value, size_t size) {
  set_has_match_method();
  match_method_.SetNoArena(_default_match_method_,
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:apollo.perception.probabilistic_fusion_config.ModelConfigs.match_method)
}
 ::std::string* ModelConfigs::mutable_match_method() {
  set_has_match_method();
  // @@protoc_insertion_point(field_mutable:apollo.perception.probabilistic_fusion_config.ModelConfigs.match_method)
  return match_method_.MutableNoArena(_default_match_method_);
}
 ::std::string* ModelConfigs::release_match_method() {
  // @@protoc_insertion_point(field_release:apollo.perception.probabilistic_fusion_config.ModelConfigs.match_method)
  clear_has_match_method();
 ...
 void ModelConfigs::set_allocated_match_method(::std::string* match_method) {
  ...
  // @@protoc_insertion_point(field_set_allocated:apollo.perception.probabilistic_fusion_config.ModelConfigs.match_method)
}
...
void ModelConfigs::clear_max_match_distance() {
 ...
 float ModelConfigs::max_match_distance() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.max_match_distance)
  return max_match_distance_;
}
 void ModelConfigs::set_max_match_distance(float value) {
  set_has_max_match_distance();
  max_match_distance_ = value;
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.max_match_distance)
}
...
void ModelConfigs::clear_max_lidar_invisible_period() {
 ...
 float ModelConfigs::max_lidar_invisible_period() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.max_lidar_invisible_period)
 ...
 void ModelConfigs::set_max_lidar_invisible_period(float value) {
  ...
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.max_lidar_invisible_period)
}
...
void ModelConfigs::clear_max_radar_invisible_period() {
 ...
 float ModelConfigs::max_radar_invisible_period() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.max_radar_invisible_period)
 ...
 void ModelConfigs::set_max_radar_invisible_period(float value) {
  ...
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.max_radar_invisible_period)
}
...
void ModelConfigs::clear_max_radar_confident_angle() {
 ...
 float ModelConfigs::max_radar_confident_angle() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.max_radar_confident_angle)
 ...
 void ModelConfigs::set_max_radar_confident_angle(float value) {
  ...
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.max_radar_confident_angle)
}
...
void ModelConfigs::clear_min_radar_confident_distance() {
 ...
 float ModelConfigs::min_radar_confident_distance() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.min_radar_confident_distance)
 ...
 void ModelConfigs::set_min_radar_confident_distance(float value) {
  ...
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.min_radar_confident_distance)
}
...
void ModelConfigs::clear_publish_if_has_lidar() {
 ...
 bool ModelConfigs::publish_if_has_lidar() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.publish_if_has_lidar)
  return publish_if_has_lidar_;
}
 void ModelConfigs::set_publish_if_has_lidar(bool value) {
  set_has_publish_if_has_lidar();
  publish_if_has_lidar_ = value;
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.publish_if_has_lidar)
}
...
void ModelConfigs::clear_publish_if_has_radar() {
 ...
 bool ModelConfigs::publish_if_has_radar() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.publish_if_has_radar)
  return publish_if_has_radar_;
}
 void ModelConfigs::set_publish_if_has_radar(bool value) {
  set_has_publish_if_has_radar();
  publish_if_has_radar_ = value;
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.publish_if_has_radar)
}
...
void ModelConfigs::clear_publish_sensor() {
 ...
 const ::std::string& ModelConfigs::publish_sensor() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.publish_sensor)
 ...
 void ModelConfigs::set_publish_sensor(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.publish_sensor)
}
 void ModelConfigs::set_publish_sensor(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:apollo.perception.probabilistic_fusion_config.ModelConfigs.publish_sensor)
}
 void ModelConfigs::set_publish_sensor(const char* value, size_t size) {
  set_has_publish_sensor();
  publish_sensor_.SetNoArena(_default_publish_sensor_,
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:apollo.perception.probabilistic_fusion_config.ModelConfigs.publish_sensor)
}
 ::std::string* ModelConfigs::mutable_publish_sensor() {
  set_has_publish_sensor();
  // @@protoc_insertion_point(field_mutable:apollo.perception.probabilistic_fusion_config.ModelConfigs.publish_sensor)
  return publish_sensor_.MutableNoArena(_default_publish_sensor_);
}
 ::std::string* ModelConfigs::release_publish_sensor() {
  // @@protoc_insertion_point(field_release:apollo.perception.probabilistic_fusion_config.ModelConfigs.publish_sensor)
  clear_has_publish_sensor();
 ...
 void ModelConfigs::set_allocated_publish_sensor(::std::string* publish_sensor) {
  ...
  // @@protoc_insertion_point(field_set_allocated:apollo.perception.probabilistic_fusion_config.ModelConfigs.publish_sensor)
}
...
void ModelConfigs::clear_use_radar() {
 ...
 bool ModelConfigs::use_radar() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.use_radar)
  return use_radar_;
}
 void ModelConfigs::set_use_radar(bool value) {
  set_has_use_radar();
  use_radar_ = value;
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.use_radar)
}
...
void ModelConfigs::clear_use_lidar() {
 ...
 bool ModelConfigs::use_lidar() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.use_lidar)
  return use_lidar_;
}
 void ModelConfigs::set_use_lidar(bool value) {
  set_has_use_lidar();
  use_lidar_ = value;
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.use_lidar)
}
...
void ModelConfigs::clear_max_camera_invisible_period() {
 ...
 float ModelConfigs::max_camera_invisible_period() const {
  // @@protoc_insertion_point(field_get:apollo.perception.probabilistic_fusion_config.ModelConfigs.max_camera_invisible_period)
 ...
 void ModelConfigs::set_max_camera_invisible_period(float value) {
  ...
  // @@protoc_insertion_point(field_set:apollo.perception.probabilistic_fusion_config.ModelConfigs.max_camera_invisible_period)
}
